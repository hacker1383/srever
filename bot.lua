...
----config----
local bot_api_key = "265319237:AAFamcrx0DvSFmC-OBbWzcsLjVNVBuJbtUs" --pit your api key of api telegram bot
...
function is_admin(msg)-- Check if user is admin or not
  local var = false
  local admins = {119296662}-- put your id and cli pika launcher bot
